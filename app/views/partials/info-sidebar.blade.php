	<a href="/infos/24">{{{ trans('default.Info') }}}</a>
	<li><a href="/histories/24/11" >{{{ trans('default.Mission and Vision') }}}</a></li>
	<li><a href="/histories/24/12" >{{{ trans('default.Admission') }}} </a></li>
	...
	<a href="/infos/24/3"> {{{ trans('default.History')}}}  </a>               
